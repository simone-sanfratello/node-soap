...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  var firstPrefix = options.firstPrefix
  ...
  if ((style === 'rpc')&& ( ( input.parts || input.name==="element" ) || args === null) ) {
    ...
    message = self.wsdl.objectToDocumentXML(input.$name, args, input.targetNSAlias, input.targetNamespace, (input.$type || input.$lookupType), firstPrefix);
  }
